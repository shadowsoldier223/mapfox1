...
selfSay('I\'m a Knight from Nightmare Knights. I can give you a nice reward, if you do a mission for me.')
elseif msgcontains(msg, 'mission') or msgcontains(msg, 'task') or msgcontains(msg, 'quest') or msgcontains(msg, 'reward') or msgcontains(msg, 'service') then
...
selfSay('I\'m not accepting essences anymore.')
end
else
selfSay('Sorry, but you don\'t have 100 demonic essences.')
end
