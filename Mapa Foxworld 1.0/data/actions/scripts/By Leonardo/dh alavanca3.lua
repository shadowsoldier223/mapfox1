...
stonepos = {x=362, y=993, z=14, stackpos=1}
playerpos = {x=362, y=993, z=14, stackpos=225}
stone = getThingfromPos(stonepos)
player = getThingfromPos(playerpos)

if item.uid == 9887 and item.itemid == 1945 then
doRemoveItem(stone.uid,1)
doSendMagicEffect(stonepos,45)
doTransformItem(item.uid,item.itemid+1)
elseif item.uid == 9887 and item.itemid == 1946 then
