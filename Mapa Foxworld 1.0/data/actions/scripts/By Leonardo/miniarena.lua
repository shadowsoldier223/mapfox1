...
if item.uid == 9595 and item.itemid == 1945 then
player1pos = {x=440, y=551, z=4, stackpos=253}
player1 = getThingfromPos(player1pos)

player2pos = {x=444, y=551, z=4, stackpos=253}
...
nplayer1pos = {x=382, y=503, z=7}
nplayer2pos = {x=382, y=510, z=7}
