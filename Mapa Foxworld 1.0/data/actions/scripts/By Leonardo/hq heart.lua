...
if item.uid == 4324 then
queststatus = getPlayerStorageValue(cid,4324)
if queststatus == -1 then
doPlayerSendTextMessage(cid,22,"Você encontrou um Burning Heart.")
doPlayerAddItem(cid,2353,1 )
setPlayerStorageValue(cid,4324,1)
else
