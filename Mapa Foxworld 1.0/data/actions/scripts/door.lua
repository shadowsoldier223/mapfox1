...
elseif item.itemid == 5125 then
if item.actionid == 0 then
doTransformItem(item.uid,5127)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 5127 then
doTransformItem(item.uid,5125)

elseif item.itemid == 5116 then
if item.actionid == 0 then
doTransformItem(item.uid,5118)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
elseif item.itemid == 5118 then
doTransformItem(item.uid,5116)

elseif item.itemid == 6903 then
if item.actionid == 0 then
doTransformItem(item.uid,6904)
else
doPlayerSendTextMessage(cid,22,"It is locked.")
end
